...
\noindent{\bf Problem 7}: Derive the asymptotic distribution for the MLE of the submodel canonical parameter vector $\hat\beta$ and the submodel mean-value parameter vector $\hat\tau$.
