...
We simplify the above by choosing $p$ to be the vector with all components $1/d$ which corresponds to $\psi = 0$ so that $p_ie^{-\psi_i} = 1$. We will also choose $c(\psi) = n\log(d)$, so that 
$$
