...
\includegraphics{week5_p2_files/figure-beamer/unnamed-chunk-13-1.pdf}
\end{frame}
...
\includegraphics{week5_p2_files/figure-beamer/unnamed-chunk-18-1.pdf}
\end{frame}

\begin{frame}{}
\protect\hypertarget{section-16}{}
\includegraphics{week5_p2_files/figure-beamer/unnamed-chunk-19-1.pdf}
\end{frame}
...
\includegraphics{week5_p2_files/figure-beamer/unnamed-chunk-22-1.pdf}
\end{frame}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(}\FunctionTok{coef}\NormalTok{(m5))}
\NormalTok{n }\OtherTok{\textless{}{-}} \FunctionTok{nrow}\NormalTok{(dat)}
\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ dat}\SpecialCharTok{$}\NormalTok{Species}

\DocumentationTok{\#\# estimate dispersion directly}
\NormalTok{fits }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(m5, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{dp5 }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((y }\SpecialCharTok{{-}}\NormalTok{ fits)}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\NormalTok{fits) }\SpecialCharTok{/}\NormalTok{ (n }\SpecialCharTok{{-}}\NormalTok{ p)}
\NormalTok{dp5}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{pred1 }\OtherTok{\textless{}{-}}\NormalTok{ pred2 }\OtherTok{\textless{}{-}}\NormalTok{ pred3 }\OtherTok{\textless{}{-}}\NormalTok{ pred4 }\OtherTok{\textless{}{-}}\NormalTok{ pred5 }\OtherTok{\textless{}{-}} \ConstantTok{NULL}
\ControlFlowTok{for}\NormalTok{(j }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(dat))\{}
\NormalTok{  pred1[j] }\OtherTok{\textless{}{-}}\NormalTok{  (dat[j, ]}\SpecialCharTok{$}\NormalTok{Species }\SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m1\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }
                             \AttributeTok{newdata =}\NormalTok{ dat[j, ]))}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/} 
    \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m1\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }\AttributeTok{newdata =}\NormalTok{ dat[j, ])}
\NormalTok{  pred2[j] }\OtherTok{\textless{}{-}}\NormalTok{  (dat[j, ]}\SpecialCharTok{$}\NormalTok{Species }\SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m2\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }
                             \AttributeTok{newdata =}\NormalTok{ dat[j, ]))}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/} 
    \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m2\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }\AttributeTok{newdata =}\NormalTok{ dat[j, ])}
\NormalTok{  pred3[j] }\OtherTok{\textless{}{-}}\NormalTok{  (dat[j, ]}\SpecialCharTok{$}\NormalTok{Species }\SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m3\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }
                             \AttributeTok{newdata =}\NormalTok{ dat[j, ]))}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/} 
    \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m3\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }\AttributeTok{newdata =}\NormalTok{ dat[j, ])}
\NormalTok{  pred4[j] }\OtherTok{\textless{}{-}}\NormalTok{  (dat[j, ]}\SpecialCharTok{$}\NormalTok{Species }\SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m4\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }
                             \AttributeTok{newdata =}\NormalTok{ dat[j, ]))}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/} 
    \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m4\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }\AttributeTok{newdata =}\NormalTok{ dat[j, ])}
\NormalTok{  pred5[j] }\OtherTok{\textless{}{-}}\NormalTok{  (dat[j, ]}\SpecialCharTok{$}\NormalTok{Species }\SpecialCharTok{{-}} \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m5\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }
                             \AttributeTok{newdata =}\NormalTok{ dat[j, ]))}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{/} 
    \FunctionTok{predict}\NormalTok{(}\FunctionTok{update}\NormalTok{(m5\_b, }\AttributeTok{data =}\NormalTok{ dat[}\SpecialCharTok{{-}}\NormalTok{j, ]), }\AttributeTok{newdata =}\NormalTok{ dat[j, ])}
\NormalTok{\}}

\FunctionTok{c}\NormalTok{(}\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(pred1)), }\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(pred2)), }\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(pred3)), }
  \FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(pred4)), }\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{mean}\NormalTok{(pred5)))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{week5_p2_files/figure-beamer/unnamed-chunk-40-1.pdf}
\end{frame}
