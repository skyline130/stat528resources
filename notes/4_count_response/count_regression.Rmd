...
\vspace*{0.5cm}\noindent A half-normal plot of the residuals of the Poisson model is shown on the left and the relationship between the mean and the variance is shown on the right. A line showing that the variance increases linearly in the mean (not a perfect slope of 1) is also shown.
```{r}
par(mfrow = c(1,2))
